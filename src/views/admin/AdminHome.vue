    ...
    <el-container>
      ...
      <el-header>
        <el-menu router :default-active="activeIndex" mode="horizontal" :ellipsis="false" @select="handleSelect">
          ...
          <!-- <el-dropdown placement="bottom" style="position: absolute; right: 0; margin-top: 3px; margin-right: 20px;"> -->
          <div style="position: absolute; right: 0; margin-top: 3px; margin-right: 20px;">
            <!-- <img :src="imguid" style="width: 50px; height: 50px; border-radius: 50%;" @click="goToUserList"> -->
      ...
      <el-container>
        ...
        <el-container>
          <el-main style="height: 100%;">
            <router-view></router-view> <!-- 这里将渲染子路由组件 -->
          </el-main>
        </el-container>
      </el-container>
    </el-container>
