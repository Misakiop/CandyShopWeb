    ...
    <el-row justify="center">
        <div>
            ...
            <el-page-header @back="onBack" style="margin-top: 10px;">
                ...
                <template #content>
                    <div class="search">
                        <el-input v-model="inputsearch" style="width: 240px" placeholder="请输入用户名"
                            :prefix-icon="'Search'" />
                ...
                <div id="userlist">
                    <el-table :data="userList" stripe style="width: 100%; display: flex; justify-content: center;">
                        ...
                        <el-table-column prop="introduce" label="个性签名" width="100" />
                                ...
                                <el-popover effect="light" trigger="hover" placement="top" width="auto">
                                    ...
                                    <template #reference>
                                        <el-button type="primary" circle>
                                            ...
                                            <!-- <el-text :type="randomTagType" class="font-bold" style="width: 40px" truncated>
                        {{ scope.row.address }}
                      </el-text> -->
                                        </el-button>
                                    </template>
